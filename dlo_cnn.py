...
-You can make the overall network less expensive by reducing the depth of the output of the modules. To do that, reduce the number of filter of all the Conv2D of each module. Multiply them all by the same coefficient [0-1] to scale them down by the same factor, to keep the general architecture of the module similar.

"""

def stem(img_input) : # Stem module, processes input of shape (a, a, 3) and ouputs tensor of shape ~ (a/10, a/10, 384), to be passed to an Inception module
	...
	branch2 = Conv2D(64, (7, 1), strides=(1,1), padding='same')(branch2)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)

	branch2 = Conv2D(64, (1, 7), strides=(1,1), padding='same')(branch2)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)

	branch2 = Conv2D(96, (3, 3), strides=(1,1), padding='valid')(branch2)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)
	...
	branch2 = Conv2D(128, (1, 1), strides=(2,2), padding='same')(x)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)
...
def inceptBig(x) : # Inception-A module that takes input of size (a, a, b) and outputs (a, a, 384). a should be big, ~ 35

	branch1 = AveragePooling2D(strides=(1,1), padding='same')(x)

	branch1 = Conv2D(96, (1, 1), strides=(1,1), padding='same')(branch1)
	branch1 = BatchNormalization(axis=3,scale=False)(branch1)
	branch1 = Activation('relu')(branch1)

	branch2 = Conv2D(96, (1, 1), strides=(1,1), padding='same')(x)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)

	branch3 = Conv2D(64, (1, 1), strides=(1,1), padding='same')(x)
	branch3 = BatchNormalization(axis=3,scale=False)(branch3)
	branch3 = Activation('relu')(branch3)

	branch3 = Conv2D(96, (3, 3), strides=(1,1), padding='same')(branch3)
	branch3 = BatchNormalization(axis=3,scale=False)(branch3)
	branch3 = Activation('relu')(branch3)

	branch4 = Conv2D(64, (1, 1), strides=(1,1), padding='same')(x)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(96, (3, 3), strides=(1,1), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)
...
def inceptMed(x) : # Inception-B module that takes input of size (a, a, b) and outputs (a, a, 1024). a should be medium, ~ 17
	...
	branch2 = Conv2D(384, (1, 1), strides=(1,1), padding='same')(x)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)

	branch3 = Conv2D(192, (1, 1), padding='same')(x)
	branch3 = BatchNormalization(axis=3,scale=False)(branch3)
	branch3 = Activation('relu')(branch3)

	branch3 = Conv2D(224, (1, 7), padding='same')(branch3)
	branch3 = BatchNormalization(axis=3,scale=False)(branch3)
	...
	branch4 = Conv2D(192, (1, 1), padding='same')(x)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(192, (1, 7), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(224, (7, 1), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(224, (1, 7), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(256, (7, 1), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)
...
def inceptSmall(x) : # Inception-C that takes input of size (a, a, b) and outputs (a, a, 1536). a should be small, ~ 8

	branch1 = AveragePooling2D(strides=(1,1), padding='same')(x)

	branch1 = Conv2D(256, (1, 1), strides=(1,1), padding='same')(branch1)
	branch1 = BatchNormalization(axis=3,scale=False)(branch1)
	branch1 = Activation('relu')(branch1)

	branch2 = Conv2D(256, (1, 1), strides=(1,1), padding='same')(x)
	branch2 = BatchNormalization(axis=3,scale=False)(branch2)
	branch2 = Activation('relu')(branch2)

	branch3 = Conv2D(384, (1, 1), padding='same')(x)
	branch3 = BatchNormalization(axis=3,scale=False)(branch3)
	branch3 = Activation('relu')(branch3)

	branch3a = Conv2D(256, (3, 1), padding='same')(branch3)
	branch3a = BatchNormalization(axis=3,scale=False)(branch3a)
	branch3a = Activation('relu')(branch3a)

	branch3b = Conv2D(256, (1, 3), padding='same')(branch3)
	branch3b = BatchNormalization(axis=3,scale=False)(branch3b)
	branch3b = Activation('relu')(branch3b)

	branch4 = Conv2D(384, (1, 1), padding='same')(x)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(448, (3, 1), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4 = Conv2D(512, (1, 3), padding='same')(branch4)
	branch4 = BatchNormalization(axis=3,scale=False)(branch4)
	branch4 = Activation('relu')(branch4)

	branch4a = Conv2D(256, (3, 1), padding='same')(branch4)
	branch4a = BatchNormalization(axis=3,scale=False)(branch4a)
	branch4a = Activation('relu')(branch4a)

	branch4b = Conv2D(256, (1, 3), padding='same')(branch4)
...
x = stem(img_input) # apply the Stem module on the Input layer and return x of shape (7,7,384)
